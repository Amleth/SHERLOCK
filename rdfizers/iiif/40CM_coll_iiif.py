...
wb_index = xlrd.open_workbook(args.iiif_excel_index)
index = wb_index.sheet_by_index(0)
## Images de la collection
wb_img = xlrd.open_workbook(args.iiif_excel_coll)
img = wb_img.sheet_by_index(0)

...
def process(data):
    ...
    # E36 Visual Item
    gravure = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "uuid"], True))
    t(gravure, a, crm("E36_Visual_Item"))
    t(collection, crm("P106_is_composed_of"), gravure)

    # Identifiant Mercure Galant
    gravure_id_MG = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "identifiant MG"], True))
    ...
    # Identifiant IIIF
    gravure_id_iiif = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "identifiant iiif"], True))
    ...
    if data["INV"] or data["SCULP"]:
        gravure_E12 = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "E12", "uuid"], True))
        t(gravure_E12, a, crm("E12_Production"))
        t(gravure_E12, crm("P108_has_produced"), gravure)

    # Invenit
    if data["INV"]:
        gravure_invenit = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "E12", "invenit", "uuid"], True))
        ...
        gravure_invenit_auteur = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "E12", "invenit", "auteur"], True))
        t(gravure_invenit_auteur, a, crm("E21_Person"))
        t(gravure_invenit_auteur, RDFS.label, l(data["INV"]))
        gravure_invenit_E13 = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "E12", "invenit", "E13"], True))
        ...
        if data["Technique de la représentation [Avec Maj et au pl.]"]:
            gravure_E29 = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "E12", "E29"], True))
            ...
            gravure_E29_E13 = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "E12", "E55", "E13"], True))
    ...
    # Sculpsit
    if data["SCULP"]:
        gravure_sculpsit = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "E12", "sculpsit", "uuid"], True))
        ...
        gravure_sculpsit_auteur = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "E12", "sculpsit", "auteur"], True))
        t(gravure_sculpsit_auteur, a, crm("E21_Person"))
        t(gravure_sculpsit_auteur, RDFS.label, l(data["SCULP"]))
        gravure_sculpsit_E13 = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "E12", "sculpsit", "E13"], True))
        ...
        if data["Technique de la gravure [Avec Maj et au pl.]"]:
            gravure_E55 = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "E12", "E55", "uuid"], True))
            t(gravure_E55, a, crm("E55_Type"))
            t(gravure_E55, RDFS.label, l(data["Technique de la gravure [Avec Maj et au pl.]"]))
            gravure_E55_E13 = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "E12", "E55", "E13"], True))
    ...
    if data["Cote article lié OBVIL"]:
        ...
        try:
            article_F2 = she(cache_corpus.get_uuid(
                ["Corpus", "Livraisons", id_livraison, "Expression TEI", "Articles", id_article, "F2"]))
            gravure_seeAlso_E13 = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "seeAlso", "E13"], True))
            ...
            if data["Commentaire Cote article lié OBVIL"]:
                gravure_seeAlso_P3_E13 = she(
                    cache.get_uuid(["estampes du Mercure Galant", id, "E36", "seeAlso", "note", "E13"], True))
    ...
    # Lien Gallica
    if data["Lien Gallica"]:
        lien_gallica = u(data["Lien Gallica"])
        t(lien_gallica, crm("P2_has_type"), she("e73699b0-9638-4a9a-bfdd-ed1715416f02"))
        img_gallica_E13 = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "gallica", "E13"], True))
    ...
    if data["Titre sur l'image"]:
        gravure_titre = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "titre sur l'image"], True))
    ...
    if data[" [titre descriptif forgé]*  (Avec Maj - accentuées]"]:
        gravure_titre = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "titre forgé"], True))
        t(gravure_titre, a, crm("E13_Attribute_Assignement"))
        t(gravure_titre, crm("P14_carried_out_by"), she("684b4c1a-be76-474c-810e-0f5984b47921"))
        t(gravure_titre, crm("P140_assigned_attribute_to"), gravure)
    ...
    if data["[Titre dans le péritexte: Avis, article…]"]:
        gravure_titre = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "titre péritexte"], True))
        t(gravure_titre, a, crm("E13_Attribute_Assignement"))
        t(gravure_titre, crm("P14_carried_out_by"), she("684b4c1a-be76-474c-810e-0f5984b47921"))
        t(gravure_titre, crm("P140_assigned_attribute_to"), gravure)
...
# 					gravure_zone_img = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", lieu, "zone de l'image (E36)", "uuid"], True))
# 					t(gravure_zone_img, a, crm("E36_Visual_Item"))
# 					gravure_zone_img_E13 = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", lieu, "zone de l'image (E36)", "E13"], True))
...
# 						if lieu_uuid:
# 							gravure_lieu_E13 = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", lieu, "zone de l'image (E36)", "lieu représenté"], True))
...
# 							cache.get_uuid(["estampes du Mercure Galant", id, "E36", sujet, "zone de l'image (E36)", "uuid"], True))
# 						t(gravure_zone_img, a, crm("E36_Visual_Item"))
# 						gravure_zone_img_E13 = she(
# 							cache.get_uuid(["estampes du Mercure Galant", id, "E36", sujet, "zone de l'image (E36)", "E13"], True))
# 						t(gravure_zone_img_E13, a, crm("E13_Attribute_Assignement"))
# 						t(gravure_zone_img_E13, crm("P14_carried_out_by"), she("684b4c1a-be76-474c-810e-0f5984b47921"))
# 						t(gravure_zone_img_E13, crm("P140_assigned_attribute_to"), gravure)
# 						t(gravure_zone_img_E13, crm("P141_assigned"), gravure_zone_img)
...
# 				if data[19]:
# 					gravure_notes_E13 = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "notes", "E13"], True))
...
# 					t(gravure_notes_E13, crm("P141_assigned"), l(data[19]))
# 					t(gravure_notes_E13, crm("P177_assigned_property_type"), crm("P3_has_note"))
#
# 				## Autres liens externes
# 				if data[20]:
# 					try:
# 						response = requests.get(data[20])
# 						lien_externe = u(data[20])
# 						gravure_lien_externe_E13 = she(
# 							cache.get_uuid(["estampes du Mercure Galant", id, "E36", "lien externe", "E13"], True))
...
# 					except:
# 						print("'" + data[20] + "' n'est pas une URL valide")
#
#
# 				## Bibliographie relative à la gravure
# 				if data[21]:
# 					biblio = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "bibliographie", "uuid"], True))
# 					t(biblio, a, crm("E31_Document"))
# 					t(biblio, RDFS.label, l(data[21]))
# 					## E13 Attribute Assignement
# 					gravure_biblio_E13 = she(cache.get_uuid(["estampes du Mercure Galant", id, "E36", "bibliographie", "E13"], True))
